...
function NextButtonClick(event) {
  if (!validateEligibility()) {
    var errorElement = document.getElementById("elgibility-error");
    errorElement.innerText = "Please select an eligibility option.";
    errorElement.style.marginTop = "1rem"; // Adjust the margin as needed
    errorElement.style.display = "block"; // Set display to block to shift to the next line
  } else {
    var errorElement = document.getElementById("elgibility-error");
    errorElement.innerText = "";
    errorElement.style.marginTop = "0"; // Reset margin when there is no error
    errorElement.style.display = "none"; // Hide the error element when there is no error
